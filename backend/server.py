from fastapi import FastAPI, APIRouter, HTTPException, Depends, Request, BackgroundTasks, UploadFile, File, Form, Body, Query
...
async def get_menu_link(request: Request, current_user: dict = Depends(get_current_user)):
    ...
    if origin:
        ...
        base_url = os.environ.get('REACT_APP_BACKEND_URL', 'https://resto-finance-40.preview.emergentagent.com')
