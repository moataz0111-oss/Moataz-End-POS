...
export default function Dashboard() {
  ...
  const allQuickActions = [
    { label: t('pos'), icon: ShoppingCart, path: '/pos', color: 'bg-gradient-to-br from-orange-400 to-orange-600', key: 'showPOS', id: 'pos' },
    { label: t('tables'), icon: LayoutGrid, path: '/tables', color: 'bg-gradient-to-br from-blue-400 to-blue-600', key: 'showTables', id: 'tables' },
    { label: t('orders'), icon: ClipboardList, path: '/orders', color: 'bg-gradient-to-br from-amber-400 to-amber-600', key: 'showOrders', id: 'orders' },
    { label: t('kitchen_display'), icon: ChefHat, path: '/kitchen', color: 'bg-gradient-to-br from-yellow-400 to-yellow-600', key: 'showKitchen', id: 'kitchen' },
    { label: t('reports'), icon: BarChart3, path: '/reports', color: 'bg-gradient-to-br from-amber-400 to-amber-600', key: 'showReports', id: 'reports' },
    { label: t('smart_reports'), icon: PieChart, path: '/smart-reports', color: 'bg-gradient-to-br from-emerald-400 to-emerald-600', key: 'showSmartReports', id: 'smart-reports' },
    { label: t('ratings'), icon: Star, path: '/ratings', color: 'bg-gradient-to-br from-yellow-400 to-yellow-500', key: 'showRatings', id: 'ratings' },
    ...
    { label: t('warehouse'), icon: Warehouse, path: '/warehouse-manufacturing', color: 'bg-gradient-to-br from-indigo-500 to-indigo-700', key: 'showWarehouse', id: 'warehouse-manufacturing' },
    { label: t('branch_orders'), icon: Truck, path: '/branch-orders', color: 'bg-gradient-to-br from-lime-400 to-lime-600', key: 'showBranchOrders', id: 'branch-orders' },
    { label: t('inventory_reports'), icon: Package, path: '/inventory-reports', color: 'bg-gradient-to-br from-purple-500 to-purple-700', key: 'showInventoryReports', id: 'inventory-reports' },
    ...
    { label: t('reservations'), icon: CalendarDays, path: '/reservations', color: 'bg-gradient-to-br from-rose-400 to-rose-600', key: 'showReservations', id: 'reservations' },
    { label: t('hr'), icon: UserCog, path: '/hr', color: 'bg-gradient-to-br from-green-400 to-green-600', key: 'showHR', id: 'hr' },
    { label: t('call_logs'), icon: Headphones, path: '/call-logs', color: 'bg-gradient-to-br from-cyan-400 to-cyan-600', key: 'showCallLogs', id: 'call-logs' },
    { label: t('loyalty'), icon: Gift, path: '/loyalty', color: 'bg-gradient-to-br from-pink-400 to-pink-600', key: 'showLoyalty', id: 'loyalty' },
    { label: t('coupons'), icon: Gift, path: '/coupons', color: 'bg-gradient-to-br from-violet-400 to-violet-600', key: 'showCoupons', id: 'coupons' },
    { label: t('settings'), icon: Settings, path: '/settings', color: 'bg-gradient-to-br from-gray-400 to-gray-600', key: 'showSettings', id: 'settings' },
  ];
