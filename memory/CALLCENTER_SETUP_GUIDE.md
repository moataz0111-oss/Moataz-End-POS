...
```
https://language-pos.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://language-pos.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://language-pos.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://language-pos.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://language-pos.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://language-pos.preview.emergentagent.com/api/callcenter/webhook" \
