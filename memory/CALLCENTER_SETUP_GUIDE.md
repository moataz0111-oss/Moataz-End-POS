...
```
https://restomanager-27.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://restomanager-27.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://restomanager-27.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://restomanager-27.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://restomanager-27.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://restomanager-27.preview.emergentagent.com/api/callcenter/webhook" \
