...
```
https://restomanage-10.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://restomanage-10.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://restomanage-10.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://restomanage-10.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://restomanage-10.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://restomanage-10.preview.emergentagent.com/api/callcenter/webhook" \
