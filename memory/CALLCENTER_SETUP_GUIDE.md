...
```
https://resto-translate-3.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://resto-translate-3.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://resto-translate-3.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://resto-translate-3.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://resto-translate-3.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://resto-translate-3.preview.emergentagent.com/api/callcenter/webhook" \
