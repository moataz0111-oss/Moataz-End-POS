...
```
https://impersonate-admin-1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://impersonate-admin-1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://impersonate-admin-1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://impersonate-admin-1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://impersonate-admin-1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://impersonate-admin-1.preview.emergentagent.com/api/callcenter/webhook" \
