...
```
https://restoadmin-2.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://restoadmin-2.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://restoadmin-2.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://restoadmin-2.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://restoadmin-2.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://restoadmin-2.preview.emergentagent.com/api/callcenter/webhook" \
