...
```
https://arabigo-menu.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://arabigo-menu.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://arabigo-menu.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://arabigo-menu.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://arabigo-menu.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://arabigo-menu.preview.emergentagent.com/api/callcenter/webhook" \
