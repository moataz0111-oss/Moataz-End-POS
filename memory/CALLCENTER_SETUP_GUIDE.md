...
```
https://resto-inventory-43.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://resto-inventory-43.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://resto-inventory-43.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://resto-inventory-43.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://resto-inventory-43.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://resto-inventory-43.preview.emergentagent.com/api/callcenter/webhook" \
