...
```
https://resto-maestro-1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://resto-maestro-1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://resto-maestro-1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://resto-maestro-1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://resto-maestro-1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://resto-maestro-1.preview.emergentagent.com/api/callcenter/webhook" \
